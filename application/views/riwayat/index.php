	...
	<div class="row">
		<div class="col-md-12">
			<div class="card border-dark">
				...
				<div class="card-body">
					<table class="table display responsive wrap" style="width:100%" id="table-riwayat">
...
<!-- Modal -->
<div class="modal fade" id="detail-riwayat" data-backdrop="static" data-keyboard="false" tabindex="-1"
